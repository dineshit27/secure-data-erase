...
import { Shield, Chrome, Clock, FileText, Key, Trash2, ArrowRight, Activity } from "lucide-react";
import { PageWrapper } from "@/components/layout/PageWrapper";
import { StatusBadge } from "@/components/ui/StatusBadge";
import LiveRunFeed from "@/components/ui/LiveRunFeed";
...
const tools = [
  ...
  { id: "runs-history", icon: Activity, title: "Runs / History", desc: "Filter, paginate, and export run events" },
];
    ...
    <PageWrapper>
      <div className="flex min-h-[calc(100vh-4rem)]">
        ...
        <main className="flex-1 p-6 sm:p-8 overflow-y-auto">
          ...
          <LiveRunFeed toolId={activeTool?.id} />
