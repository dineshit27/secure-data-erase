        ...
        <>
          ...
          <div className="space-y-2 mb-6">
            {categories.map((cat) => (
              <label
                key={cat.id}
                className={`flex items-start justify-between p-3 rounded-lg bg-surface border ${
                  cat.count === 0 ? "opacity-50 border-border/30" : cat.sensitive ? "border-warning/20 cursor-pointer" : "border-border cursor-pointer"
                }`}
                data-interactive
              >
